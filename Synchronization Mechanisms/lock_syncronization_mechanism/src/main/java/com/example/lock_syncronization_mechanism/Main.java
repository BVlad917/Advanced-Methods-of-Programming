package com.example.lock_syncronization_mechanism;
...
import com.example.lock_syncronization_mechanism.Controller.ListOfProgramsController;
import com.example.lock_syncronization_mechanism.Model.Expression.*;
import com.example.lock_syncronization_mechanism.Model.Statement.*;
import com.example.lock_syncronization_mechanism.Model.Type.BoolType;
...
import com.example.lock_syncronization_mechanism.Model.Type.StringType;
...
import com.example.lock_syncronization_mechanism.Model.Value.StringValue;
...
public class Main extends Application {
    ...
    private static IStatement getEx14() {
        return new CompoundStatement(new VariableDeclarationStatement("v1", new RefType(new IntType())),
                new CompoundStatement(new VariableDeclarationStatement("v2", new RefType(new IntType())),
                        new CompoundStatement(new NewStmt("v1", new ValueExpression(new IntValue(20))),
                                new CompoundStatement(new NewStmt("v2", new ValueExpression(new IntValue(30))),
                                        new CompoundStatement(new newLockStmt("x"),
                                                new CompoundStatement(
                                                        new forkStatement(new CompoundStatement(
                                                                new forkStatement(new CompoundStatement(new LockStatement("x"), new CompoundStatement(new writeToHeap("v1", new ArithmeticExpression(new readFromHeap(new VariableExpression("v1")), new ValueExpression(new IntValue(1)), "-")), new UnlockStatement("x")))),
                                                                new CompoundStatement(new LockStatement("x"), new CompoundStatement(new writeToHeap("v1", new ArithmeticExpression(new readFromHeap(new VariableExpression("v1")), new ValueExpression(new IntValue(1)), "+")), new UnlockStatement("x")))
                                                        )),
                                                        new CompoundStatement(
                                                                new forkStatement(new CompoundStatement(
                                                                        new forkStatement(new writeToHeap("v2", new ArithmeticExpression(new readFromHeap(new VariableExpression("v2")), new ValueExpression(new IntValue(1)), "+"))),
                                                                        new writeToHeap("v2", new ArithmeticExpression(new readFromHeap(new VariableExpression("v2")), new ValueExpression(new IntValue(1)), "+"))
                                                                )),
                                                                new CompoundStatement(new NoOperationStatement(), new CompoundStatement(new NoOperationStatement(), new CompoundStatement(new NoOperationStatement(), new CompoundStatement(new NoOperationStatement(), new CompoundStatement(new NoOperationStatement(), new CompoundStatement(new NoOperationStatement(), new CompoundStatement(new NoOperationStatement(), new CompoundStatement(new NoOperationStatement(), new CompoundStatement(new NoOperationStatement(), new CompoundStatement(
                                                                        new PrintStatement(new readFromHeap(new VariableExpression("v1"))), new PrintStatement(new readFromHeap(new VariableExpression("v2")))
                                                                ))))))))))
                                                        )
                                                ))))));
    }
