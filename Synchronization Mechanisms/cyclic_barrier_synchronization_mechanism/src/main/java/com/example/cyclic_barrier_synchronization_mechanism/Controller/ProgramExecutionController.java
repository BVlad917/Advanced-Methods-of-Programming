...
public class ProgramExecutionController {
    ...
    @FXML
    private TableView<Pair<Integer, String>> barrierTable;

    @FXML
    private TableColumn<Pair<Integer, String>, Integer> barrierTableAddressColumn;

    @FXML
    private TableColumn<Pair<Integer, String>, String> barrierTableThreadsWaitingColumn;
    ...
    void initialize() {
        ...
        this.barrierTableThreadsWaitingColumn.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().getValue()));
    ...
    private void populateBarrierTable() {
        ArrayList<Pair<Integer, String>> barrierTableElems = new ArrayList<>();
        this.currentProgramState.getBarrierTable().getContent().forEach((key, value) -> barrierTableElems.add(new Pair<>(key, value.getValue().toString())));
        this.barrierTable.setItems(FXCollections.observableList(barrierTableElems));
    }
