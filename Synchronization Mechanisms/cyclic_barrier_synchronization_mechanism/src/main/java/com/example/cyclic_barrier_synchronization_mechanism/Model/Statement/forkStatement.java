...
import com.example.cyclic_barrier_synchronization_mechanism.Model.ADT.MyDictionary;
import com.example.cyclic_barrier_synchronization_mechanism.Model.ADT.MyStack;
...
public class forkStatement implements IStatement{
    ...
    public ProgramState execute(ProgramState currentState) throws MyException {
        ...
        return new ProgramState(forkedExecutionStack, forkedSymbolTable, currentState.getOutput(), currentState.getFileTable(), currentState.getHeapTable(), currentState.getBarrierTable(), this.statement);
    }
