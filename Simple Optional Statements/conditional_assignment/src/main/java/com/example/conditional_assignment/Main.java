package com.example.conditional_assignment;
...
import com.example.conditional_assignment.Controller.ListOfProgramsController;
import com.example.conditional_assignment.Model.Expression.*;
import com.example.conditional_assignment.Model.Statement.*;
import com.example.conditional_assignment.Model.Type.BoolType;
import com.example.conditional_assignment.Model.Type.IntType;
import com.example.conditional_assignment.Model.Type.RefType;
...
import com.example.conditional_assignment.Model.Value.IntValue;
...
public class Main extends Application {
    ...
    private static IStatement getEx14() {
        return new CompoundStatement(new VariableDeclarationStatement("a", new RefType(new IntType())), new CompoundStatement(new VariableDeclarationStatement("b", new RefType(new IntType())), new CompoundStatement(new VariableDeclarationStatement("v", new IntType()),
                new CompoundStatement(new NewStmt("a", new ValueExpression(new IntValue(0))), new CompoundStatement(new NewStmt("b", new ValueExpression(new IntValue(0))),
                        new CompoundStatement(new writeToHeap("a", new ValueExpression(new IntValue(1))), new CompoundStatement(new writeToHeap("b", new ValueExpression(new IntValue(2))),
                                new CompoundStatement(new ConditionalAssignment("v", new RelationalExpression(new readFromHeap(new VariableExpression("a")), new readFromHeap(new VariableExpression("b")), "<"), new ValueExpression(new IntValue(100)), new ValueExpression(new IntValue(200))),
                                        new CompoundStatement(new PrintStatement(new VariableExpression("v")),
                                                new CompoundStatement(new ConditionalAssignment("v", new RelationalExpression(new ArithmeticExpression(new readFromHeap(new VariableExpression("b")), new ValueExpression(new IntValue(2)), "-"), new readFromHeap(new VariableExpression("a")), ">"), new ValueExpression(new IntValue(100)), new ValueExpression(new IntValue(200))),
                                                        new PrintStatement(new VariableExpression("v"))))))))))));
    }
}