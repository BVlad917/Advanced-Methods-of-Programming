package com.example.switch_statement;
...
import com.example.switch_statement.Controller.ListOfProgramsController;
import com.example.switch_statement.Model.Expression.*;
import com.example.switch_statement.Model.Statement.*;
import com.example.switch_statement.Model.Type.BoolType;
import com.example.switch_statement.Model.Type.IntType;
import com.example.switch_statement.Model.Type.RefType;
...
public class Main extends Application {
    ...
    private static IStatement getEx14() {
        return new CompoundStatement(new VariableDeclarationStatement("a", new IntType()), new CompoundStatement(new VariableDeclarationStatement("b", new IntType()), new CompoundStatement(new VariableDeclarationStatement("c", new IntType()),
                new CompoundStatement(new AssignStatement("a", new ValueExpression(new IntValue(1))), new CompoundStatement(new AssignStatement("b", new ValueExpression(new IntValue(2))), new CompoundStatement(new AssignStatement("c", new ValueExpression(new IntValue(5))),
                        new CompoundStatement(new SwitchStatement(new ArithmeticExpression(new VariableExpression("a"), new ValueExpression(new IntValue(10)), "*"),
                                ...
                                new ValueExpression(new IntValue(10)), new CompoundStatement(new PrintStatement(new ValueExpression(new IntValue(100))), new PrintStatement(new ValueExpression(new IntValue(200)))),
