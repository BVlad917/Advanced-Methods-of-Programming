package com.example.for_statement;
...
import com.example.for_statement.Controller.ListOfProgramsController;
import com.example.for_statement.Model.Expression.*;
import com.example.for_statement.Model.Statement.*;
import com.example.for_statement.Model.Type.BoolType;
import com.example.for_statement.Model.Type.IntType;
import com.example.for_statement.Model.Type.RefType;
import com.example.for_statement.Model.Type.StringType;
import com.example.for_statement.Model.Value.BoolValue;
import com.example.for_statement.Model.Value.IntValue;
import com.example.for_statement.Model.Value.StringValue;
...
public class Main extends Application {
    ...
    private static IStatement getEx14() {
        return new CompoundStatement(new VariableDeclarationStatement("v", new IntType()), new CompoundStatement(new AssignStatement("v", new ValueExpression(new IntValue(20))),
                new CompoundStatement(new ForStatement(new AssignStatement("v", new ValueExpression(new IntValue(0))), new RelationalExpression(new VariableExpression("v"), new ValueExpression(new IntValue(3)), "<"), new AssignStatement("v", new ArithmeticExpression(new VariableExpression("v"), new ValueExpression(new IntValue(1)), "+")),
