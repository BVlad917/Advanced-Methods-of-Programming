...
import com.example.sleep.Controller.ListOfProgramsController;
import com.example.sleep.Model.Expression.*;
import com.example.sleep.Model.Statement.*;
import com.example.sleep.Model.Type.BoolType;
import com.example.sleep.Model.Type.IntType;
...
import com.example.sleep.Model.Value.IntValue;
...
public class Main extends Application {
    ...
    private static IStatement getEx14() {
        return new CompoundStatement(new VariableDeclarationStatement("v", new IntType()), new CompoundStatement(new AssignStatement("v", new ValueExpression(new IntValue(10))),
                new CompoundStatement(new forkStatement(new CompoundStatement(new AssignStatement("v", new ArithmeticExpression(new VariableExpression("v"), new ValueExpression(new IntValue(1)), "-")), new CompoundStatement(new AssignStatement("v", new ArithmeticExpression(new VariableExpression("v"), new ValueExpression(new IntValue(1)), "-")), new PrintStatement(new VariableExpression("v"))))),
                        new CompoundStatement(new SleepStmt(10), new PrintStatement(new ArithmeticExpression(new VariableExpression("v"), new ValueExpression(new IntValue(10)), "*"))))));
    }
}